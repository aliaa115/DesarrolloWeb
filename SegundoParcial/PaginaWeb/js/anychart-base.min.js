...
Cba=function(a,b){switch(a){case 1:return"chart is not set or can not be properly recognized. Use chart() method to set it.";case 2:return"Scale is not set. Use scale() method to set it.";case 3:return"Table.contents() accepts only an Array of Arrays as it's first argument.";case 4:return'Feature "'+b[0]+'" is not supported in this module. See modules list at https://docs.anychart.com/Quick_Start/Modules for details.';case 5:return b[0]+" should be only "+b[1]+" type"+(b[2]?" ("+b[2]+").":
...
b[1]+"()' instead. "+b[2];case 404:return b[0]+" with id='"+b[1]+"' is not found in data tree. Please check what you are looking for.";case 11:return"Can not fit gantt chart timeline to task with id '"+b[0]+"' because both fields 'actualStart' and 'actualEnd' must be correctly specified in data item.";case 12:return'Series type "'+b[0]+'" does not support error settings - only Area, Bar, Column, Line, Marker, Spline, SplineArea, StepLine and StepLineArea do.';case 13:return"Toolbar chart is not specified. Please set a chart using toolbar.chart() method.";
...
var Yc=SC;var saa={0:"Can't find an error message that corresponds to the specified error code",1:"Requested stage type is not supported",2:"chart should be defined to render stage",3:"Stage should have a DOM element",4:"Unable to set the parent component",5:"Trying to perform an operation with the disposed element",6:"Synchronous rendering didn't clean up all dirty states",7:"Can't add an element constructed by another Stage",8:"Wrong arguments passed to swapChildren",9:"Path must start with moveTo command",
...
LE=uu.prototype;$.G("anychart.standalones.labelsFactory",function(){var a=new uu;a.ja(!0,$.Xl("standalones.labelsFactory"));return a});LE.draw=LE.Y;LE.parentBounds=LE.ia;LE.chart=LE.P;LE.add=LE.add;LE.clear=LE.clear;LE.measure=LE.measure;LE.measureWithTransform=LE.Zk;$.g=wu.prototype;$.g.xg=function(a){return $.p(a)?(this.jc.xg=a,this):this.jc.xg};$.g.cj=function(a){return $.p(a)?(this.jc.cj=a,this):this.jc.cj};$.g.im=function(a){return $.p(a)?(this.jc.im=a,this):this.jc.im};$.g.jm=function(a){return $.p(a)?(this.jc.jm=a,this):this.jc.jm};$.g.getData=function(a){var b=this.jc.xg;return b?b.get.apply(b,arguments):void 0};$.g.vl=function(a){var b=this.jc.xg?this.jc.xg.o(a):void 0;$.p(b)||(b=(b=this.jc.values.series)?b.value.o(a):void 0);return b};
...
$E.draw=$E.Y;$E.parentBounds=$E.ia;$E.chart=$E.P;$.H(qv,$.gd);$.g=qv.prototype;$.g.getContext=function(){return{parentElement:this.b,titleElement:this.j,separatorElement:this.f,contentElement:this.g}};$.g.Ua=function(){sv(this);return this.b};$.g.WN=function(){var a=$.Af(this.Ua(),"margin");$.jf(this.Ua(),this.cb.G.x-a.left,this.cb.G.y-a.top)};$.g.visible=function(a){return $.p(a)?($.vf(this.Ua(),!!a),this):"none"!=this.Ua().style.display};$.g.lb=function(){var a=$.tf(this.Ua());return new $.J(0,0,a.width,a.height)};
...
eF.items=eF.items;eF.itemsFormatter=eF.kP;eF.margin=eF.margin;eF.padding=eF.padding;eF.background=eF.background;eF.title=eF.title;eF.titleSeparator=eF.VV;eF.paginator=eF.uM;eF.tooltip=eF.Wa;eF.getRemainingBounds=eF.pd;eF.getPixelBounds=eF.tb;eF=iw.prototype;$.G("anychart.standalones.legend",function(){var a=new iw;a.K($.Xl("standalones.legend"));return a});eF.draw=eF.Y;eF.parentBounds=eF.ia;eF.chart=eF.P;eF.itemsSource=eF.aA;$.H($.jw,$.Kq);$.jw.prototype.qa=2;var fF=function(){var a={};$.Wp(a,[[0,"enabled",$.fq],[0,"duration",function(a){return null===a?this.kf("duration"):$.O(a,this.i("duration"),!0)}]]);return a}();$.U($.jw,fF);$.jw.prototype.F=function(){var a={};$.sq(this,fF,a);return a};$.jw.prototype.X=function(a,b){$.kq(this,fF,a,b)};$.jw.prototype.fe=function(a,b,c){b=null;$.da(a)||null===a?(b={enabled:!!a},$.p(c)&&(b.duration=c)):(0,window.isNaN)(+a)||(b={enabled:!0,duration:+a});return b};
...
BF.getPixelBounds=BF.tb;BF=cy.prototype;$.G("anychart.standalones.axes.linear",function(){var a=new cy;a.Fa("standalones.linearAxis");return a});BF.padding=BF.padding;BF.draw=BF.Y;BF.parentBounds=BF.ia;BF.chart=BF.P;$.H($.dy,Eu);$.dy.prototype.ph=function(a){a:{var b=a.type;switch(b){case "mouseout":b="axismarkerout";break;case "mouseover":b="axismarkerover";break;case "mousemove":b="axismarkermove";break;default:a=null;break a}a={type:b,target:this,originalEvent:a,rawValue:fy(this),formattedValue:"Value: "+fy(this),offsetX:a.offsetX,offsetY:a.offsetY}}a&&this.dispatchEvent(a)};$.dy.prototype.qa=Eu.prototype.qa|4;$.dy.prototype.ra=Eu.prototype.ra;var CF={};$.Wp(CF,[$.Z.xI,[0,"scaleRangeMode",Fk]]);$.U($.dy,CF);
...
$.g.X=function(a,b){$.nz.B.X.call(this,a,b);$.kq(this,$.UF,a)};$.H(pz,$.nz);$.Jt(pz,$.nz);var VF=$.nz.prototype;VF.scale=VF.scale;VF.axis=VF.axis;VF.layout=VF.Ae;VF.isHorizontal=VF.Gb;VF=pz.prototype;$.G("anychart.standalones.axisMarkers.range",function(){return new pz});VF.draw=VF.Y;VF.parentBounds=VF.ia;VF.chart=VF.P;$.H($.qz,$.dy);var WF={};$.Wp(WF,[[0,"value",$.eq]]);$.U($.qz,WF);$.g=$.qz.prototype;$.g.qa=$.dy.prototype.qa;$.g.ra=$.dy.prototype.ra;$.g.scale=function(a){return this.cp(a)};$.g.F=function(){var a=$.qz.B.F.call(this);$.sq(this,WF,a);return a};$.g.X=function(a,b){$.qz.B.X.call(this,a,b);$.kq(this,WF,a,b)};$.H(rz,$.qz);$.Jt(rz,$.qz);var XF=$.qz.prototype;XF.scale=XF.scale;XF.axis=XF.axis;XF.layout=XF.Ae;XF.background=XF.background;XF.padding=XF.padding;XF.isHorizontal=XF.Gb;XF=rz.prototype;
$.G("anychart.standalones.axisMarkers.text",function(){return new rz});XF.draw=XF.Y;XF.parentBounds=XF.ia;XF.chart=XF.P;$.H(sz,Eu);sz.prototype.qa=Eu.prototype.qa|2;var YF={};$.Wp(YF,[[0,"format",$.Bq],[0,"axisIndex",$.eq]]);$.U(sz,YF);$.g=sz.prototype;$.g.Tf=function(a){return $.p(a)?(this.D!=a&&(this.D=a,this.u(16,1)),this):this.D};$.g.x=function(a){$.p(a)&&this.oo!=a&&(this.oo=a,this.u(4,9));return this};$.g.y=function(a){$.p(a)&&this.po!=a&&(this.po=a,this.u(4,9));return this};
